...
const vehicles = [
  ...
  { name: 'Toyota GL Grandia Tourer', qty: '1 Unit', desc: 'Upscale touring van for executive and VIP transport' },
  { name: 'Foton', qty: '1 Unit', desc: 'Reliable light commercial vehicle for varied transport needs' },
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="max-w-2xl flex flex-col gap-7 bg-black/50 backdrop-blur-md border border-white/10 rounded-3xl p-8 lg:p-12 shadow-2xl">
            <div>
              <span className="eyebrow-dash text-[#d4a53a] mb-4">
                Our Fleet
              </span>
              <h2 className="font-heading text-[#fefefe] text-3xl sm:text-4xl leading-tight text-balance mb-5">
                Vehicles Ready to Support{' '}
                <span className="text-[#d4a53a]">Your Requirements</span>
              </h2>
              <p className="font-inter text-[#fefefe] text-base leading-relaxed">
