        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="lg:w-80 flex-shrink-0">
            ...
            <h2 className="font-sans font-black text-[#383838] text-3xl sm:text-4xl leading-tight text-balance mb-5">
              Committees &amp; <span className="text-[#f58c23]">Governance</span>
            </h2>
          ...
          <div className="flex-1 grid sm:grid-cols-2 gap-5">
            {committees.map((committee) => {
              ...
              return (
                <div
                  key={committee.name}
                  className="bg-[#f9f7f4] rounded-2xl p-7 border border-[#e8e3dc] hover:border-[#f58c23]/40 hover:shadow-md transition-all duration-200"
                >
                  <div className="w-11 h-11 rounded-xl bg-[#f58c23]/10 flex items-center justify-center mb-5">
