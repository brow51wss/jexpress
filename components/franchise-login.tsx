...
export default function FranchiseLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#fff8f0] flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d8] shadow-sm p-8 lg:p-10">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="w-14 h-14 rounded-xl bg-[#f58c23]/10 flex items-center justify-center mb-5">
              <RiLockLine size={26} className="text-[#f58c23]" />
            </div>
            <span className="inline-block text-[#f58c23] font-inter text-xs font-semibold uppercase tracking-[0.2em] mb-3">
              Restricted Access
            </span>
            <h1 className="font-sans font-black text-[#383838] text-2xl leading-tight mb-2">
              Franchise Portal
            </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-[#e8e0d8] focus:border-[#f58c23] focus:ring-2 focus:ring-[#f58c23]/20 text-[#383838] placeholder:text-[#bbb] rounded-xl px-4 py-3.5 text-sm font-inter outline-none transition-all duration-200 pr-12"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 bg-[#f58c23] hover:bg-[#d97b1a] disabled:bg-[#f58c23]/60 text-white font-bold text-base px-8 py-4 rounded-xl transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#f58c23]/30 mt-1"
            >
              {loading ? (
                <>
        ...
        <p className="text-center text-[#aaa] font-inter text-xs mt-6 leading-relaxed">
          ...
          <a
            ...
            className="text-[#f58c23] hover:underline underline-offset-2"
          >
