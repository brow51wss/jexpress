    ...
    <>
      ...
      <section className="relative bg-[#383838] overflow-hidden">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at top right, #f58c23 0%, transparent 70%)' }}
          aria-hidden="true"
        />
        <div
          className="absolute bottom-0 left-0 w-1/3 h-1/2 opacity-5 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at bottom left, #fed16c 0%, transparent 70%)' }}
          aria-hidden="true"
        />
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 bg-[#f58c23]/15 border border-[#f58c23]/30 text-[#fed16c] text-xs font-inter font-semibold uppercase tracking-widest px-4 py-2 rounded-full mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-sans font-black text-[#383838] text-3xl sm:text-4xl lg:text-5xl leading-tight text-balance mb-6">
                Why Choose{' '}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={title}
                  className="bg-white border border-[#e8e0d8] rounded-2xl p-6 flex flex-col gap-3"
                >
                  <div className="w-2 h-2 rounded-full bg-[#f58c23]" />
                  <p className="font-sans font-bold text-[#383838] text-sm leading-snug">{title}</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-sans font-black text-[#383838] text-3xl sm:text-4xl lg:text-5xl leading-tight text-balance">
              What You Get as a{' '}
              <span className="text-[#f58c23]">Franchise Partner</span>
            </h2>
          </div>
          <div className="max-w-2xl mx-auto flex flex-col gap-4">
            {benefits.map((item) => (
              <div
                key={item}
                className="flex items-center gap-5 bg-[#fff8f0] border border-[#e8e0d8] rounded-2xl px-7 py-5"
              >
                <RiCheckboxCircleFill size={24} className="text-[#f58c23] flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-sans font-black text-[#383838] text-3xl sm:text-4xl lg:text-5xl leading-tight text-balance mb-4">
              Services You Can{' '}
              <span className="text-[#f58c23]">Offer</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service) => {
              ...
              return (
                <div
                  key={service.title}
                  className="bg-white rounded-2xl border border-[#e8e0d8] p-7 flex flex-col gap-4 hover:border-[#f58c23] hover:shadow-xl hover:shadow-[#f58c23]/10 transition-all duration-300 hover:-translate-y-1 group"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#f58c23]/10 flex items-center justify-center group-hover:bg-[#f58c23] transition-colors duration-300">
                    <Icon size={22} className="text-[#f58c23] group-hover:text-white transition-colors duration-300" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-sans font-black text-[#383838] text-3xl sm:text-4xl lg:text-5xl leading-tight text-balance mb-6">
                Is This{' '}
                <span className="text-[#f58c23]">Right for You?</span>
              </h2>
              <p className="font-inter text-[#6b6b6b] text-base leading-relaxed">
              ...
              {audience.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-5 bg-[#fff8f0] border border-[#e8e0d8] rounded-2xl px-7 py-5"
                  >
                    <div className="w-11 h-11 rounded-xl bg-[#f58c23]/10 flex items-center justify-center flex-shrink-0">
                      <Icon size={20} className="text-[#f58c23]" />
                    </div>
      ...
      <section className="py-24 bg-[#383838] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-sans font-black text-white text-3xl sm:text-4xl lg:text-5xl leading-tight text-balance">
              How It{' '}
              <span className="text-[#f58c23]">Works</span>
            </h2>
          </div>
          <div className="grid sm:grid-cols-3 gap-6 lg:gap-10">
            {steps.map((step, idx) => (
              <div key={step.number} className="flex flex-col gap-5 relative">
                {idx < steps.length - 1 && (
                  <div className="hidden sm:block absolute top-6 left-[calc(100%_-_1.5rem)] w-12 h-px bg-white/10" aria-hidden="true" />
                )}
                <div className="flex items-center gap-4">
                  <span className="font-black text-[#f58c23]/30 text-5xl font-sans leading-none select-none">
                    {step.number}
                  </span>
                </div>
      ...
      <section className="py-24 bg-[#fff8f0]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <div className="w-14 h-14 rounded-xl bg-[#f58c23]/10 flex items-center justify-center mx-auto mb-6">
              <TrendingUp size={26} className="text-[#f58c23]" strokeWidth={1.75} />
            </div>
            <span className="inline-block text-[#f58c23] font-inter text-xs font-semibold uppercase tracking-[0.2em] mb-4">
              The Opportunity
            </span>
      ...
      <section className="py-24 bg-[#383838] relative overflow-hidden">
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at center, #f58c23 0%, transparent 70%)' }}
          aria-hidden="true"
        />
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <span className="inline-block text-[#fed16c] font-inter text-xs font-semibold uppercase tracking-[0.2em] mb-6">
            Take the First Step
          </span>
