      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-inter text-white/60 text-base sm:text-lg leading-relaxed mx-auto">
            Discover top destinations, travel tips, and itineraries across the Philippines.
            Let Jexpress be your trusted partner on every journey.
          </p>
        </div>
      </div>
